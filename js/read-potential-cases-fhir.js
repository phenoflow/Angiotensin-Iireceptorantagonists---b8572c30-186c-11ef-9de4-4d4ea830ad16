...
(async () => {
  ...
  await fs.writeFile("angiotensin-iireceptorantagonists-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("angiotensin-iireceptorantagonists-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
